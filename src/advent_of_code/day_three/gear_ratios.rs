...
impl GridNumberLocator {
    ...
    fn get_char_at(grid: &Grid, i: usize, j: usize) -> Option<char> {
        match grid.get(i) {
            None => None,
    ...
    fn consume_temporary_state(
        ...
        let adjacent_chars: Vec<char> = hashset
            .iter()
...
impl PartNumbersCalculator {
    ...
    fn calculate_sum(&self, numbers_data: &Vec<NumberData>) -> i32 {
...
impl GearRatios {
    ...
    pub fn calculatr_sum_of_part_numbers(&self) -> i32 {
        self.parts_number_calculator
            .calculate_sum(&self.numbers_data_vec)
    }
}
...
mod test {
    use crate::advent_of_code::day_three::gear_ratios::{
        GearRatios, GridNumberLocator, GridParser, NumberData, PartNumbersCalculator,
    };
    ...
    fn calculates_sum_of_part_numbers() {
        ...
        let sum = part_numbers_calculator.calculate_sum(&numbers_data);
